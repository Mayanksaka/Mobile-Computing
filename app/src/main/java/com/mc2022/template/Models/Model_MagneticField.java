...
@Entity(tableName = "magnetic_field_Model")
public class Model_MagneticField {
    ...
    public Model_MagneticField(int num, long time, double x_axis, double y_axis, double z_axis){
        this.num= num;
        this.time=time;
        this.x_axis=x_axis;
        this.y_axis=y_axis;

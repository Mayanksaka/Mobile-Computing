...
@Entity(tableName = "accelerometer_Model")
public class Model_Linear_Accelerometer {
    ...
    public Model_Linear_Accelerometer( int num, long time, double x_axis,double y_axis, double z_axis){
        this.num= num;
        this.time=time;
        this.x_axis=x_axis;
        this.y_axis=y_axis;
